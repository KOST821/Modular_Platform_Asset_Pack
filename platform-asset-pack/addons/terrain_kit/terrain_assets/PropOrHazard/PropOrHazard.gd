...
## The amount of damage this hazard deals.
...
@export_group("Pulsing Timer", "pulse_")
## The time (in seconds) the hazard stays active.
@export_range(0.1, 10.0, 0.1, "or_greater") var pulse_active_time: float = 0.0
## The time (in seconds) the hazard waits before activating.
@export_range(0.1, 10.0, 0.1, "or_greater") var pulse_rest_time: float = 0.0
